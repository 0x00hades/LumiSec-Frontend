...
const myRouter = createBrowserRouter([
  ...
  // ── Protected — pathless layout route so it never competes with '/' login ──
  // A route without a path is transparent: it wraps its children's elements
  // without adding any path prefix. This eliminates the redirect loop that
  // occurred when two routes both claimed path: '/'.
  {
    ...
    children: [
      ...
      // SIEM (no tool-level restriction — all authenticated users can access)
